...
import UserProgression from './userprogressionRoutes'
// import DeleteLeadsRoute from './deleteLeadsRoute'
...
router.use('/user-progression', UserProgression)
// router.use('/deleteleads', DeleteLeadsRoute)
